...
<head>
    ...
    <title>[IJTech] - Review assignment for manuscript #<?php echo $journal_id;?></title>
    <style type="text/css">
                            ...
                            <table  cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td class="content-block">
                                        <h5 style="color: #333; font-style: italic; padding: 10px; margin-bottom: 10px; border-bottom: solid 1px #DDD; background-color: #F7F7F7; font-weight: normal;"><i class="fa fa-file-text-o"></i> Review assignment for manuscript #<?php echo $journal_id;?></h5>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="content-block">

                                       	<p>Dear <b> <?php echo $reviewer[0]['salutation'].' '.$reviewer[0]['first_name'].' '.$reviewer[0]['last_name'];?> </b></p>
										<p>Thank you for your willingness to review manuscript <b>#<?php echo $journal_id;?></b>, entitled <b>[ <?php echo strip_tags($journal[0]['sub_title']);?> ]</b></p>
										<p>You can access the manuscript and fill the review form after logging in at [ <a href="<?php echo site_url().'login';?>" target="_blank"><?php echo site_url().'login';?></a> ] using your IJTech account:</p>
                    Username: <?php echo $email; ?><br>
                    <?php if(isset($newPassword)){ ?>
                    Password: <?php echo $newPassword; ?>
                    <?php }else{ ?>
                    If you want a new password: <a href="<?php echo site_url().'login/reset_password?email='.$email; ?>" target=""><?php echo site_url().'login/reset_password?email='.$email; ?></a>
                    <?php } ?>
                    
                    <p>Review guideline: <a href=<?php echo '"'.base_url().'file/IJTech_reviewer_guideline.pdf" target="_blank">'; echo base_url(); echo 'file/IJTech_reviewer_guideline.pdf'; ?></a>.</p>
