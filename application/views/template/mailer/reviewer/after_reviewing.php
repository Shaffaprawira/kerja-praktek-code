...
<head>
    ...
    <title>[IJTech] - Thank you for your review on manuscript #<?php echo $journal_id;?></title>
    <style type="text/css">
                            ...
                            <table  cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td class="content-block">
										...
										<p>Thank you for your review on manuscript <b>#<?php echo $journal_id;?></b> entitled <b>[ <?php echo strip_tags($journal[0]['sub_title']);?> ]</b></p>

										<p>As a token of appreciation, we would like to provide you with a certificate for this contribution in your dashboard. You can access your review comments by logging into the editorial management system at [ <a href="<?php echo site_url();?>" target="_blank"><?php echo site_url();?></a> ].</p>
										<p>We hope that you will consider International Journal of Technology as a potential journal for your own submissions in the future.</p>
                                    </td>
                                </tr>                                
                                <tr>
                                ...
                                <tr>
                                    <td><b>Your comments:</b><br><?php echo $comments;?></td>
                                </tr>
                              </table>
                        </td>
                    </tr>
