						...
						<table  cellpadding="0" cellspacing="0">
							...
							<tr>
								<td class="content-block">
									<h5 style="color: #333; font-style: italic; padding: 10px; margin-bottom: 10px; border-bottom: solid 1px #DDD; background-color: #F7F7F7; font-weight: normal;"><i class="fa fa-file-text-o"></i> Expired review assignment is now extended</h5>
								</td>
							</tr>
								<tr>
									<td class="content-block">
	<p>Dear <?=$name?>,</p>
	<p>Our previous email informed you that the review assignment for paper entitled "<?=$title?>" (#<?=$journal_id?>) has been expired. However, we have decided to extend the period for you to give your review comment for this paper.</p>
	<p>Please submit your review at <a href="https://ijtech.eng.ui.ac.id/dashboard/review/active" target="_blank">https://ijtech.eng.ui.ac.id/dashboard/review/active</a>. Just in case you forget your username and/or password, please click <a href="https://ijtech.eng.ui.ac.id/login/reset_password?email=<?=$email?>" title="open in new tab" target="_blank">here</a>. A short guideline for how to use our system for reviewing can be found <a href="https://ijtech.eng.ui.ac.id/file/IJTech_reviewer_guideline.pdf" target="_blank" title="open in new tab">here</a>.</p>
