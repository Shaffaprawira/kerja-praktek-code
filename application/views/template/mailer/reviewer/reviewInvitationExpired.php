...
<head>
	...
	<title>Re: [IJTech] Invitation reminder for manuscript #<?=$journal_id?></title>
...
<table class="body-wrap">
				...
				<table class="main" width="100%" cellpadding="0" cellspacing="0">
					<tr>
						...
						<table  cellpadding="0" cellspacing="0">
							<tr>
								<td>
									<img class="img-responsive" src="<?=base_url()?>assets/front/img/logo_lama.png"/>
								</td>
							</tr>
							<tr>
								<td class="content-block">
									<h5 style="color: #333; font-style: italic; padding: 10px; margin-bottom: 10px; border-bottom: solid 1px #DDD; background-color: #F7F7F7; font-weight: normal;"><i class="fa fa-file-text-o"></i> Review invitation expired</h5>
								</td>
							</tr>
								<tr>
									<td class="content-block">
	...
	<p>Since then, we have also sent at least 3 emails reminding about the invitation. However, we have not received your confirmation. </p>
	...
	<p>We do understand that our emails may have arrived during your inconvenient time. Please allow us to invite you again in other ocasion.</p>
	<p>Please also kindly let us know if you think that you have responded our invitation previously or if you have any other technical issues.</p>
	<p>Thank you</p>
									</td>
							</tr>                                
							<tr>
