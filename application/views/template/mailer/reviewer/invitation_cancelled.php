...
<head>
	...
	<title>[IJTech] Review request cancelled because manuscript #<?php echo $id;?> is withdrawn</title>
				...
				<table class="main" width="100%" cellpadding="0" cellspacing="0">
					<tr>
						...
						<table  cellpadding="0" cellspacing="0">
							<tr>
								<td>
									<!--img class="img-responsive" src="http://localhost/ijtech/download?f=assets/front/img/logo_lama.png&k=<?php echo md5($email.date('Y-m-d H:i:s').'[IJTech] Review request cancelled because manuscript #'.$id.' is withdrawn');?>"/-->
									<img class="img-responsive" src="http://ijtech.eng.ui.ac.id/assets/front/img/logo_lama.png"/>
								</td>
							</tr>
							<tr>
								<td class="content-block">
									<h5 style="color: #333; font-style: italic; padding: 10px; margin-bottom: 10px; border-bottom: solid 1px #DDD; background-color: #F7F7F7; font-weight: normal;"><i class="fa fa-file-text-o"></i> Review request cancelled because manuscript #<?php echo $id;?> is withdrawn</h5>
								</td>
							</tr>
								<tr>
									<td class="content-block">
	<p>Dear <?php echo $name;?>,</p>
	<p>We have requested your review for manuscript #<?php echo $id;?> entitled "<?php echo $sub_title;?>." However, now the author decided to withdraw this manuscript. Hence, this email is to let you know that your review is no longer required.</p>
	
	<p>Thank you for your contribution if you have reviewed this manuscript. Sorry for the inconvenience.</p>
									</td>
							</tr>                                
							<tr>
