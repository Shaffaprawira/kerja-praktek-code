                            ...
                            <table  cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td class="content-block">
										...
										<p>Please find the attached manuscript or, alternatively, you can access it by logging into the editorial management system at [ <a href="<?php echo site_url();?>" target="_blank"><?php echo site_url();?></a> ] using your IJTech username and password. A short guideline for how to use our system for reviewing can be found <a href="<?php echo base_url()."file/IJTech_reviewer_guideline.pdf";?>" target="_blank">here</a>.</p>
