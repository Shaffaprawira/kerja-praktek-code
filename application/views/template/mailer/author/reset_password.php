...
<head>
    ...
    <title>[IJTech] - Reset Password</title>
                            ...
                            <table  cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td class="content-block">
                                        <h5 style="color: #333; font-style: italic; padding: 10px; margin-bottom: 10px; border-bottom: solid 1px #DDD; background-color: #F7F7F7; font-weight: normal;"><i class="fa fa-file-text-o"></i> Reset Password </h5>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="content-block">
                                        <p>We have received a request to reset the password for the account associated with this email address. Here is the information for the new password:</p>

										<p style="border:dashed 1px #DDDDDD; background-color: #F7F7F7; padding:10px">
											Username: <i><?php echo $user_id;?></i><br/>
											Password: <i><?php echo $password;?></i>
										</p>
										<p>For security reason, we advise you to change your password to a more secure one as soon as you can login to your account. If you are not the one requesting this password reset, please contact us at ijtech@eng.ui.ac.id.</p>
                                    </td>
                                </tr>
                                <tr>
