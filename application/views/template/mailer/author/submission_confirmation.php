...
<head>
    ...
    <title>[IJTech] - Confirmation of manuscript submission (Manuscript #<?php echo $journal_id;?>)</title>
                            ...
                            <table  cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td class="content-block">
                                        <h5 style="color: #333; font-style: italic; padding: 10px; margin-bottom: 10px; border-bottom: solid 1px #DDD; background-color: #F7F7F7; font-weight: normal;"><i class="fa fa-file-text-o"></i> Manuscript Submission Confirmation</h5>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="content-block">
										...
										<p>Your <?php echo $journal[0]['round'] > 1 ? 'revised':'';?> manuscript entitled <b>"<?php echo $journal[0]['sub_title'];?>"</b> has been successfully submitted to International Journal of Technology (IJTech) Online System.</p>

										<p>Your manuscript ID #: <b><?php echo $journal_id;?></b>.</p>

										<p>Please quote the above manuscript ID in all future correspondence. If there are any changes in your postal or e-mail address, please log into IJTech Online System at <a href="<?php echo site_url();?>" target="_blank"><?php echo site_url();?></a> and edit your contact and/or personal information as appropriate.</p>

										<p>You can also view the status of your manuscript at any time by checking your Author Account after logging in to <a href="<?php echo site_url().'dashboard';?>" target="_blank"><?php echo site_url().'dashboard';?></a>.</p>

										<p>Thank you for submitting your manuscript to International Journal of Technology (IJTech) Online System.</p>
