...
<head>
    ...
    <title>[IJTech] - Revision Reminder for manuscript #<?php echo $journal_id;?></title>
                            ...
                            <table  cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td class="content-block">
                                        <h5 style="color: #333; font-style: italic; padding: 10px; margin-bottom: 10px; border-bottom: solid 1px #DDD; background-color: #F7F7F7; font-weight: normal;"><i class="fa fa-file-text-o"></i> Revision Reminder</h5>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="content-block">
										...
										<p>This is a polite reminder that we recently requested a revision of your manuscript, which is now due on <b>[ <?php echo $time;?> ]</b>.  If we do not receive your revision within that time, we will assume that you are not sending a revision and this constitutes your manuscript being inactivated.</p>

										<p>If you need additional time to complete your revision, please informing us of the date you expect to submit it via email to ijtech@eng.ui.ac.id.</p>

                                        <p style="padding:10px;background:#FFFFDD;border:dashed 1px #DDD">Please ignore this message if you have uploaded your revised manuscript on the website.</p>
                                    </td>
                                </tr>                                
                                <tr>
