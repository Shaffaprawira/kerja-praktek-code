                            ...
                            <table  cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td class="content-block">
                                        <h3 style="color: #555; padding-bottom: 10px; margin-bottom: 10px; text-align: center; border-bottom: solid 1px #DDD">Decision (Accepted) on Manuscript #<?php echo $journal_id;?></h3>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="content-block">
                                        ...
                                        <p>We are delighted to inform you that your manuscript has been accepted for publication in the International Journal of Technology (IJTech).</p>We will notify you again for the next process required toward publication. Thank you.</p>
