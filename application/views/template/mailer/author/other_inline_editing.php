                            ...
                            <table  cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td class="content-block">
                                        ...
                                        <p>We received your confirmation regarding Line-editing process, that you will conduct line editing through one of the professional English editing services that we suggested in the previous email. </p>
                                        <p>When the line editing process is done, you need to send by email to <a href="mailto:ijtech@eng.ui.ac.id">ijtech@eng.ui.ac.id</a></p>
                                        <ol>
                                            <li>the results of line editing (comments track changes)</li>
                                            <li>invoice (receipt order) from the line editing services</li>
                                            <li>revised manuscript based on line editing comments (please noticed to add all author(s) name and affiliation).</li>
                                        </ol>
                                        <p>Any confirmation and submission of line editing results, receipt order and revised manuscript should be submitted no later than <b>3 days</b> after the date of this email.</p>
