...
<head>
    ...
    <title>[IJTech] Screening result for #<?php echo $journal_id;?>: need revision</title>
                            ...
                            <table  cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td class="content-block">                                        
                                         <h5 style="color: #333; font-style: italic; padding: 10px; margin-bottom: 10px; border-bottom: solid 1px #DDD; background-color: #F7F7F7; font-weight: normal;"><i class="fa fa-file-text-o"></i> Screening result: Need Revision</h5>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="content-block">
										...
										<p>I am writing to you regarding the manuscript <b>#<?php echo $journal_id;?></b> entitled <b>"<?php echo $journal[0]['sub_title'];?>"</b> which you submitted to International Journal of Technology (IJTech).</p>

										<p>After we made an initial screening we found some problems including:</p>
                                        <?php 
                                            $list = explode(';', $notes);
                                            echo "<ol>";
                                            ...
                                            echo "</ol>";
                                        ?>
                                        <p>We recommend that this manuscript be revised in order to proceed to peer review.</p>
                                        <p>If you plan to revise your manuscript, please indicate your intent in the following page:<br>
                                        <a href="<?php echo base_url('dashboard/detail/submission/'.$journal[0]['sub_id'])?>"><?php echo base_url('dashboard/detail/submission/'.$journal[0]['sub_id'])?></a>
                                        </p>
										<p>If we do not receive your intent by <b><?php echo $dd;?></b>, we will presume that you have withdrawn your submission from IJTech.</p>
										<p>Please do not hesitate to contact us if you need extension for this schedule.</p>
                                    </td>
                                </tr>                                
                                <tr>
