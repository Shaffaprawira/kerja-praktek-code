...
<head>
    ...
    <title>[IJTech] - Journal Publishing</title>
                            ...
                            <table  cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td class="content-block">
                                        <h5 style="color: #333; font-style: italic; padding: 10px; margin-bottom: 10px; border-bottom: solid 1px #DDD; background-color: #F7F7F7; font-weight: normal;"><i class="fa fa-file-text-o"></i>Journal Publishing</h5>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="content-block">
                                        ...
                                        <p>Greetings from Depok!</p>

                                        <p>On behalf of the Editorial Board, I am pleased to inform you that your article entitled <b><?php echo $journal[0]['sub_title'];?></b> has been published online in <i><?php echo $issue_label;?></i>. You can check the online version at: <a href="<?php echo $issue_url;?>"><?php echo $issue_url;?></a></p>

                                        <p>The articles are available to be accessed and downloaded free of charge. The hardcopy version is being printed and one copy will be delivered to the corresponding author.</p>

                                        <p>Thank you for your contribution to IJTech and we look forward to a good collaboration in the next future.</p> 
