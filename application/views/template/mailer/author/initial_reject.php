...
<head>
    ...
    <title>[IJTech] - Initial Screening (Rejected) manuscript #<?php echo $journal_id;?></title>
                            ...
                            <table  cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td class="content-block">
                                        <h5 style="color: #333; font-style: italic; padding: 10px; margin-bottom: 10px; border-bottom: solid 1px #DDD; background-color: #F7F7F7; font-weight: normal;"><i class="fa fa-file-text-o"></i> Screening Result : Reject</h5>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="content-block">
                                        
										<p>Dear <?php echo $author[0]['salutation'].' '.$author[0]['first_name'].' '.$author[0]['last_name'];?>,</p>

                                        <p>I am writing to you regarding the manuscript <b>#<?php echo $journal_id;?></b> entitled <b>"<?php echo $journal[0]['sub_title'];?>"</b> which you submitted to International Journal of Technology. Your paper was read with interest; unfortunately, based on initial screening by Editor in Charge for <b><i><?php echo $journal[0]['section_title'];?></i></b> section,  the manuscript does not fit the criteria for publication in IJTech and therefore we must reject it.</p>

                                        <p>Kindly note that the manuscript for an article to be accepted for publication should comply with these particular points: </p>
                                        <ol>
                                            <li>The manuscript is organized and presented in an intelligible fashion and is written in standard English.</li>
                                            <li>The manuscript have not been submitted or published elsewhere.</li>
                                            <li>The manuscript should be original writing that enhances the existing body of knowledge in the given subject area of <b><i><?php echo $journal[0]['section_title'];?></i></b>. It may also include the relevant subjects on management of Technology and Innovation such as Regulatory Policy and Technological social implications. </li>
                                            <li>Experiments, statistics, and other analyses are performed to a high technical standard and are described in sufficient details and analyses. </li>
                                            <li>Results and Analyses indicate a clear novelty, emphasizing on a new findings or theories, in the given specific area of research topic.</li>
                                            <li>Although review paper is eligible for submission, we strongly emphasize on in-depth analyses on the given topics leading to a novel contribution on the relevant knowledge in the area of <b><i><?php echo $journal[0]['section_title'];?></i></b></li>
                                        </ol>

                                        <p style="border:solid 1px #DDD; padding:5px">
                                        ...
                                        <p>Thank you for considering IJTech as the publication outlet of your paper. We hope the results of this initial screening will not discourage you from the submission of future manuscripts.</p>
