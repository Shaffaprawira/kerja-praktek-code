...
<head>
	...
	<title>[IJTech] Manuscript #<?php echo $id;?> is withdrawn</title>
				...
				<table class="main" width="100%" cellpadding="0" cellspacing="0">
					<tr>
						...
						<table  cellpadding="0" cellspacing="0">
							<tr>
								<td>
									<!--img class="img-responsive" src="http://localhost/ijtech/download?f=assets/front/img/logo_lama.png&k=<?php echo md5($email.date('Y-m-d H:i:s').'[IJTech] Manuscript #'.$id.' is withdrawn');?>"/-->
									<img class="img-responsive" src="http://ijtech.eng.ui.ac.id/assets/front/img/logo_lama.png"/>
								</td>
							</tr>
							<tr>
								<td class="content-block">
									<h5 style="color: #333; font-style: italic; padding: 10px; margin-bottom: 10px; border-bottom: solid 1px #DDD; background-color: #F7F7F7; font-weight: normal;"><i class="fa fa-file-text-o"></i> Manuscript #<?php echo $id;?> is withdrawn</h5>
								</td>
							</tr>
								<tr>
									<td class="content-block">
	<p>Dear <?php echo $author;?>,</p>
	<p>This email is to notify you that your manuscript #<?php echo $id;?> entitled "<?php echo $sub_title;?>" is now withdrawn from International Journal of Technology (IJTech).</p>
									</td>
							</tr>                                
							<tr>
