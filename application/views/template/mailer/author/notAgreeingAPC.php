...
<head>
	...
	<title>Re: [IJTech] Article Processing Charge (APC) Confirmation for Manuscript #<?php echo $submission_id;?></title>
				...
				<table class="main" width="100%" cellpadding="0" cellspacing="0">
					<tr>
						...
						<table  cellpadding="0" cellspacing="0">
							<tr>
								<td>
									<!--img class="img-responsive" src="http://localhost/ijtech/download?f=assets/front/img/logo_lama.png&k=<?php echo md5($email.date('Y-m-d H:i:s').'Re: [IJTech] Article Processing Charge (APC) Confirmation for Manuscript #'.$submission_id);?>"/-->
									<img class="img-responsive" src="http://ijtech.eng.ui.ac.id/assets/front/img/logo_lama.png"/>
								</td>
							</tr>
							<tr>
								<td class="content-block">
									<h5 style="color: #333; font-style: italic; padding: 10px; margin-bottom: 10px; border-bottom: solid 1px #DDD; background-color: #F7F7F7; font-weight: normal;"><i class="fa fa-file-text-o"></i> Re: Article Processing Charge (APC) Confirmation for Manuscript #<?php echo $submission_id;?></h5>
								</td>
							</tr>
								<tr>
									<td class="content-block">
	<p>Dear <?php echo $author;?>,</p>
	<p>We have received your confirmation that you are <b>not agree</b> with our <a href="http://ijtech.eng.ui.ac.id/about/13" target="_blank">Article Processing Charge (APC) policy</a> and decided to <b>withdraw</b> your manuscript entitled "<?php echo $sub_title;?>". Hence, we will discocontinue all the related processes. Sorry for the inconvenience.</p>
									</td>
							</tr>                                
							<tr>
