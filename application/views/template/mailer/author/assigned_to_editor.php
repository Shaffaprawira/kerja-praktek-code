...
<head>
    ...
    <title>[IJTech] - Manuscript #<?php echo $journal_id;?> assigned to Editor</title>
                            ...
                            <table  cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td class="content-block">
                                        <h5 style="color: #333; font-style: italic; padding: 10px; margin-bottom: 10px; border-bottom: solid 1px #DDD; background-color: #F7F7F7; font-weight: normal;"><i class="fa fa-file-text-o"></i> Manuscript assigned to Editor</h5>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="content-block">
                                        ...
                                        <p>Ms ID <b>#<?php echo $journal_id;?></b></p>

										<p>Dear <?php echo $author['salutation'].' '.$author['first_name'].' '.$author['last_name'];?>,</p>


										<p>Your manuscript entitled <b>"<?php echo $journal[0]['sub_title'];?>"</b> has been assigned to the following editor.</p>
										
										<?php if(!empty($editor)){ foreach ($editor as $a){
											echo "<div style='border:solid 1px #AAA; background-color:#EEE; padding:10px; margin-top:5px'>";
											echo "<b>".$a['salutation'].' '.$a['first_name'].' '.$a['last_name']."</b>";
											echo "<br/>";
											echo "<i>International Journal of Technology (IJTech)</i>";
											echo "<br/>";
											echo "Email : ".($a['email'] !== "" ? $a['email'] : '---');
											echo "<br/>";
											echo "Phone : ".($a['phone'] !== "" ? $a['phone'] : '---');
											echo "<br/>";
											echo "Fax : ".($a['fax'] !== "" ? $a['fax'] : '---');
											echo "</div>";
										}}else{ echo "No editor assigned. Please contact administrator."; }
										?>

										<p>All future correspondence regarding this manuscript should be addressed to the above assigned editor.</p>

										<p>Submission of a manuscript to IJTech entails that the material reported therein has not been previously published and is not under consideration for publication elsewhere in any medium, including electronic journals and public computer databases and repositories. This manuscript is being considered with the understanding that it is submitted on an exclusive basis. If otherwise, please acknowledge.</p>

										<p>It should also be noted that all authors must have reviewed and agreed with the content of the manuscript and approved its submission. If you are a coauthor and approve its submission, no action is necessary. If you do not approve its submission to IJTech, please let us know as soon as possible.</p>

										<p>IJTech uses CrossCheck's <i>iThenticate</i> software to detect instances of similarity in submitted manuscripts. IJTech is committed to deterring plagiarism in any way, shape, and form, including self-plagiarism. Your manuscript may be screened for similarity to published material.</p>
