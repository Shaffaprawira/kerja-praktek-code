...
<head>
    ...
    <title>[IJTech] - Revise and Resubmit manuscript #<?php echo $journal_id;?></title>
                            ...
                            <table  cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td class="content-block">
                                        <h5 style="color: #333; font-style: italic; padding: 10px; margin-bottom: 10px; border-bottom: solid 1px #DDD; background-color: #F7F7F7; font-weight: normal;"><i class="fa fa-file-text-o"></i> Revise and Resubmit Manuscript</h5>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="content-block">
                                        <?php 
											$due = date('Y-m-d');
											$dd = date('d M Y', strtotime(due_date(DAY_REVISE_SCREENING, $due)));
										?> 

										<p>Dear <?php echo $author['salutation'].' '.$author['first_name'].' '.$author['last_name'];?>:</p>

										<p>Thank you for submitting your manuscript entitled <b>"<?php echo $journal[0]['sub_title'];?>"</b> to Internationl Journal of Technology (IJTech) Online System. The editorial team and a group of expert reviewers have assessed your submission and feel that it has potential for publication, and so we would like to invite you to revise the paper and resubmit for further review. </p>

										<p>We ask that you submit the revised version of your manuscript by <i>"highlighted manuscript and Please note, your revised manuscript should be accompanied by a summary of your responses to the reviewers' comments.</i> </p>

										<p>You must respond to this revise and resubmit request before <?php echo $dd;?>, after which point we will presume that you have withdrawn your submission from Internationl Journal of Technology (IJTech) Online System.</p>
