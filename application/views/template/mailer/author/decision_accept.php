                            ...
                            <table  cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td class="content-block">
                                        ...
                                        <p>The editorial board is delighted to inform you that your paper entitled &#34;<?php echo strip_tags($journal[0]['sub_title']);?>&#34; has been accepted to be published on IJTech. <b>Congratulation!</b></p>
                                        
                                        <p>In order to ensure the readability and the quality of the journal,all accepted articles to publish will be subjected to article processing charge (APC) of US$ 1000 plus tax. This fee covers the review process, layouting, DOI deposit and online publishing. An invoice will be sent to you in a separate email. <a href="https://ijtech.eng.ui.ac.id/about/13">Click here</a> for more details.</p>
