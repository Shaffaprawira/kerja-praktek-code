...
<head>
    ...
    <title>[IJTech] Decision (Rejected) on manscript #<?php echo $journal_id;?></title>
                            ...
                            <table  cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td class="content-block">
                                        <h5 style="color: #333; font-style: italic; padding: 10px; margin-bottom: 10px; border-bottom: solid 1px #DDD; background-color: #F7F7F7; font-weight: normal;"><i class="fa fa-file-text-o"></i> Editor Decision on #<?php echo $journal_id;?> : Rejected</h5>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="content-block">
                                        ...
                                        <p>I am writing to you in regards to manuscript <b>#<?php echo $journal_id;?></b> entitled <b><?php echo $journal[0]['sub_title'];?></b> which you submitted to International Journal of Technology. Your paper had been reviewed by expert referees in the specific field. Unfortunately, based on their comments it will not be possible to further consider your manuscript for publication in IJTech.</p>

                                        <p>Below, please find the detailed review comments:</p>
                                        
                                        <p style="padding: 10px; border:dashed 1px #DDD;">Notes from Editor:<br/><?php echo $notes;?></p>
                                        ...
                                        <p>Thank you for considering IJTech as the publication outlet of your paper. We hope the results of this submission will not discourage you from the submission of future manuscripts.</p>
