...
<head>
    ...
    <title>[IJTech] - Account Confirmation</title>
                            ...
                            <table  cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td class="content-block">
                                        <h5 style="color: #333; font-style: italic; padding: 10px; margin-bottom: 10px; border-bottom: solid 1px #DDD; background-color: #F7F7F7; font-weight: normal;"><i class="fa fa-file-text-o"></i>Account Confirmation</h5>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="content-block">
                                        <p>Dear <?php echo isset($name) ? $name :'User';?>,</p>

										<p>Welcome to the International Journal of Technology (IJTech) Online System for submission and review</p>

										<p>Your account has been created at <a href="<?php echo site_url();?>" target="_blank"><?php echo site_url();?></a> as follows:</p>

										<p><b>USER ID: <?php echo $user_id;?></b></p>
								        <p>Password : <i><?php echo $password;?></i></p>
                                        
										<p>If you would like to reset the password above, after login into application please click / go to the link below:</p>
										<a href="<?php echo site_url().'dashboard/edit/password';?>"><?php echo site_url().'dashboard/edit/password';?></a>

										<p>Thank you for your kind contribution. We are looking forward to receiving your manuscript at your earliest convenience.</p>
                                    </td>
                                </tr>                                
                                <tr>
