...
<head>
    ...
    <title>Re: [IJTech] - New Submission needs Initial Screening by EiC: #<?=$sec."-".$sub_id?></title>
                            ...
                            <table  cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td class="content-block">
                                        <h5 style="color: #333; font-style: italic; padding: 10px; margin-bottom: 10px; border-bottom: solid 1px #DDD; background-color: #F7F7F7; font-weight: normal;">
                                            <i class="fa fa-file-text-o"></i> Reviewer deleted because not responding</h5>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="content-block">
                                        <p>Dear Editor,</p>									
										<p>Reviewer "<?=$name?> (<?=$email?>)" is removed from the list of reviewers assigned to of manuscript 
										<a href="<?=site_url()?>dashboard/detail/submission/<?=$sub_id?>" target="_blank">#<?=$sec."-".$sub_id?></a>
										entitled "<?=$title?>" since s/he has not responded the invitation or not completing the review for at least <?=$duration?> days.</p>
										<p>We have sent a notification to this reviewer to make s/he aware about this condition.</p>
                                    </td>
                                </tr>                                
                                <tr>
