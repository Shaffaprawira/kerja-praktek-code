...
<head>
    ...
    <title>[IJTech] - New Submission needs Initial Screening by EiC: #<?php echo $journal_id;?></title>
                            ...
                            <table  cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td class="content-block">
                                        <h5 style="color: #333; font-style: italic; padding: 10px; margin-bottom: 10px; border-bottom: solid 1px #DDD; background-color: #F7F7F7; font-weight: normal;"><i class="fa fa-file-text-o"></i>New Submission needs Initial Screening by EiC: #<?php echo $journal_id;?></h5>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="content-block">
                                        <p>Dear <?php echo $editor['salutation'].' '.$editor['first_name'].' '.$editor['last_name'];?>,</p>									
										<p>A manuscript has been submitted to Section "<?php echo $journal_section;?>" in IJTech.
										Please conduct initial screening (content) using your role as Editor in Charge for this section. 
										For your quick check, here are some of the manuscript details:</p>
										
										<p><b>Title:</b> <?php echo $manuscript_title; //ruki4march2019 ?></p>
										<p><b>Authors:</b> <?php echo $authors_string; ?></p>
										<p><b>Abstract:</b> <?php echo $manuscript_abstract; ?></p>
										
										This submission is accessible in your account:</p>

										<p>URL: <a href="<?php echo site_url().'login';?>">(<?php echo site_url().'login';?>)</a></p>
