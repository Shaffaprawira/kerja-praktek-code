...
(function ($) {
    ...
    Datagrid.prototype.SearchAndOrderingTrigger = function () {
        ...
        $('.gc-search-row input.searchable-input').each(function () {
            if ($(this).val() !== '') {
								$(this).attr('prevVal',$(this).val()); //ruki 20220412
    ...
    Datagrid.prototype.listenerSearchInput = function () {
        ...
        $('.grocery-crud-table input.searchable-input').on('keyup', function (event) {
						//ruki 20220412 start
						var fire = 0;
						if(typeof($(this).attr('prevVal'))!='undefined'){
							if($(this).val()!=$(this).attr('prevVal')){
								fire = 1;
							}
						}else{
