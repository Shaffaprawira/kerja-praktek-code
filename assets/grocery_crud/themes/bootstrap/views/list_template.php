        					...
        					<thead>
        						<tr>
                                    ...
                                    <?php foreach($columns as $column){
																			if(empty($columnNoSorting) || !in_array($column->field_name,$columnNoSorting)){ 
																			?>
                                        <th class="column-with-ordering" data-order-by="<?php echo $column->field_name; ?>"><?php echo $column->display_as; ?></th>
                                    <?php }else{ ?>
                                        <th class="column" data-order-by="<?php echo $column->field_name; ?>"><?php echo $column->display_as; ?></th>
                                    <?php }} ?>
        						</tr>
        						...
        						<tr class="filter-row gc-search-row">
                                    ...
                                    <?php foreach($columns as $column){?>
                                        <td>
																					<?php 
																					if(empty($columnNoSearch) || !in_array($column->field_name,$columnNoSearch)){ 
																					?>
                                            <input type="text"
